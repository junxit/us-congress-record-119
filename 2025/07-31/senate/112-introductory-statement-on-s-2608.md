---
granule: CREC-2025-07-31-pt1-PgS4999-3
date: 2025-07-31
edition: CREC
section: SENATE
page: S4999
citation: 171 Cong. Rec. S4999
---

# Introductory Statement on S. 2608
...
```
      By Mr. THUNE (for himself, Ms. Klobuchar, Mr. Moran, and Ms. 
        Smith):
  S. 2608. A bill to amend the Food Security Act of 1985 to improve the 
...
printed in the Record, as follows:
     ...
     SECTION 1. SHORT TITLE.
       ...
       This Act may be cited as the ``CRP Improvement and 
     ...
     and''.
       ...
       (b) Emergency Haying During the Primary Nesting Season; 
     Conditions on Haying and Grazing.--Section 1233(b) of the 
     ...
     all practices, during the final 2 weeks of, and outside of, 
     the primary nesting season, on not more than 50 percent of 
     contract acres, as identified in the site-specific plan, 
     when--
...
[[Page S5000]]
     ...
     ``emergency haying, emergency grazing, or other emergency 
     use'' and inserting ``emergency grazing or other emergency 
     use''; and
       (D) in subclause (III) (as so redesignated), by striking 
     ``payments'' and inserting ``the conditions described in item 
     (aa), (bb), or (cc) of subclause (I) are met or payments''; 
     and
       (2) in paragraph (2)(B)--
       (A) by redesignating clause (ii) as clause (iii); and
       (B) by inserting after clause (i) the following:
       ``(ii) Damage to cover for wildlife populations.--Haying or 
     grazing described in paragraph (1) shall not be permitted on 
     land subject to a contract under the conservation reserve 
     program, or under a particular practice, if haying or grazing 
     during the final 2 weeks of the primary nesting season under 
     that practice, as applicable, would cause long-term damage to 
     vegetative cover for wildlife populations supported by the 
     applicable practice on that land.''.
       (c) Cost Sharing Payments for Establishment of Grazing 
     Infrastructure.--
       (1) Cost sharing payments; other federal cost share 
     assistance.--Section 1234(b) of the Food Security Act of 1985 
     (16 U.S.C. 3834(b)) is amended--
       (A) in paragraph (1)--
       (i) by striking ``establishing water'' and inserting the 
     ...
     concern.''; and
       (B) in paragraph (3), by striking ``land'' and inserting 
     ``activities required by the contract entered into under this 
     subchapter''.
     ...
     subchapter.''.
       (d) Mid-Contract Management for Activities Not Relating to 
     Haying or Grazing.--
     ...
     to haying or grazing.''.
       (e) Payment Limitation for Rental Payments.--Section 
