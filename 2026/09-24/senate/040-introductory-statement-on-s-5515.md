---
granule: CREC-2026-09-24-pt1-PgS4998-2
date: 2026-09-24
edition: CREC
section: SENATE
page: S4998
citation: 172 Cong. Rec. S4998
---

# Introductory Statement on S. 5515
...
```
      By Mr. DURBIN:
  S. 5515. A bill to improve Federal efforts with respect to the 
...
printed in the Record, as follows
     ...
     live births) for the 48 contiguous States and the District of 
     Columbia, increased from 14.5 percent in 2000 to 32.0 in 
     2021. The United States is the only industrialized nation 
     with a rising maternal mortality rate.
     ...
     Maternal Health and Reproductive Justice;
       ...
       (U) the Tulane University Mary Amelia Center for Women's 
...
[[Page S4999]]
     ...
     institutions keep the United States in the dark about ways to 
     prevent maternal deaths.
       (16) Having reliable and valid State data aggregated at the 
     Federal level are critical to the ability of the United 
     States to quell surges in maternal death and imperative for 
     researchers to identify long-lasting interventions.
     ...
     State of California has worked extensively with the 
     California State health departments, health and hospital 
     systems, and research collaborative organizations, including 
     the California Maternal Quality Care Collaborative and the 
     Alliance for Innovation on Maternal Health, to establish 
     MMRCs, wherein such State has determined the most prevalent 
     causes of maternal mortality and recorded and shared data 
     with providers and researchers, who have developed and 
     implemented safety bundles and care protocols related to 
     preeclampsia, maternal hemorrhage, peripartum cardiomyopathy, 
     and the like. In this way, the State of California has been 
     able to leverage its maternal mortality review board system, 
     generate data, and apply those data to effect changes in 
     maternal care-related protocol.
     ...
     Services (referred to in this Act (other than section 8) as 
     the ``Secretary''), acting through the Division of 
     Reproductive Health of the Centers

[[Page S5000]]

     for Disease Control and Prevention, shall establish a grant 
     program, to be known as the ``State-Based Perinatal Quality 
     ...
     collaboratives in each State, the District of Columbia, and 
     eligible territories, in order to measurably improve 
     perinatal care and perinatal health outcomes for pregnant and 
     ...
     duration of the grant period.
       (3) Definition of perinatal quality collaborative.--In this 
     subsection, the term ``perinatal quality collaborative'' 
     means a network of teams that--
     ...
     women (as defined in subsection (ll));''; and

       (ii) by adding at the end the following new subsection:
       ``(ll) Oral Health Services for Pregnant and Postpartum 
     Women.--
     ...
     in section 1905(ll)'' after ``emergency conditions''; and
     ...
     in section 1905(ll))'' after ``subparagraph (C)''.
     ...
     U.S.C. 1396a) is amended--
       ...
       (iii) in paragraph (90)(C), by striking the period at the 
     end and inserting ``; and''; and
       (iv) by inserting after paragraph (90)(C) the following new 
     paragraph:
     ...
     of such State plan)''; and
       ...
       (B) CHIP.--
       (i) In general.--Section 2107(e)(1)(K) of the Social 
     Security Act (42 U.S.C. 1397gg(e)(1)(K)) is amended to read 
     as follows:
       ``(K) Paragraphs (5) and (16) of section 1902(e) (relating 
     ...
     title XIX).''.
       (ii) Conforming amendment.--Section 2112(d)(2)(A) of the 
     ...
     through application of section 1903(v)(4)(A)(i) under section 
     ...
     this paragraph.''.
       (4) Information on benefits.--The Secretary shall make 
     publicly available on the internet website of the Department 
     of Health and Human Services information regarding benefits 
     available to pregnant and postpartum women and under the 
     ...
     amended by adding at the end the following:
       ``(mm) Increased FMAP for Extended Medical Assistance for 
...
[[Page S5001]]
     ...
     the States concerning options for Medicaid coverage and 
     ...
     inserting ``(ii), (mm), and (nn)''; and
       (B) by adding at the end the following new subsection:
       ``(nn) Increased FMAP for Medical Assistance for Obstetric 
     ...
     Social Security Act (42 U.S.C. 1396a) and subparagraph (K) of 
     section 2107(e)(1) of the Social Security Act (42 U.S.C. 
     1397gg(e)(1)), as amended by paragraph (2), and subsection 
     (mm) of section 1905 of the Social Security Act (42 U.S.C. 
     ...
     appropriate, shall enter into cooperative agreements with 
     eligible entities for the establishment or support of 
     regional centers of excellence that address implicit bias, 
     cultural competency, and respectful care practices in 
     patient-provider interactions education for the purpose of 
     enhancing and improving how health care professionals are 
     educated in implicit bias and delivering culturally competent 
     health care.
       ``(b) Eligibility.--To be eligible to enter into a 
     cooperative agreement under subsection (a), an entity shall--
       ``(1) be a public or other (as specified by the Secretary) 
     nonprofit entity that provides educational and training 
     opportunities for students and health care professionals, 
     including a health system, teaching hospital, community 
     ...
     time and in such manner, as the Secretary may require.
       ``(c) Diversity.--In selecting eligible entities with which 
     to enter into a cooperative agreement under subsection (a), 
     the Secretary shall take into account any regional 
     differences among eligible entities and make an effort to 
     ensure geographic diversity among award recipients.
     ...
     and private entities.
       ``(3) Distribution.--The Secretary shall share the 
     evaluations and overall findings described in paragraph (2) 
     with State departments of health and other relevant State 
     level offices to inform State and local best practices.
       ``(e) Definition of Maternal Mortality.--In this section, 
     the term `maternal mortality' means death of a woman that 
     occurs during pregnancy or within the 1-year period following 
     the end of such pregnancy.
     ...
     implement a program to award grants to, or enter into 
     contracts with, eligible entities to establish or expand 
     programs to grow and diversify the doula workforce, including 
     through improving the capacity and supply of health care 
     providers.
...
[[Page S5002]]
       ...
       (5) a territory;
       (6) an Indian Tribe, Tribal organization, urban Indian 
     organization, or Native Hawaiian organization;
       (7) a community-based organization; or
       (8) another appropriate public or private nonprofit entity 
     or a consortium of public or private nonprofit entities, 
     including entities that promote multidisciplinary approaches.
       (c) Use of Funds.--An eligible entity that receives a grant 
     or enters into a contract under subsection (a) shall use the 
     funds received pursuant to such grant or contract for 1 or 
     more of the following activities:
       (1) Establishing programs that provide education and 
     training to individuals seeking appropriate training or 
     certification as a full-spectrum doula.
       (2) Expanding the capacity of existing programs that 
     provide education and training to individuals seeking 
     appropriate training or certification as a full-spectrum 
     doula for the purpose of increasing the number of students 
     enrolled in such programs, including by awarding scholarships 
     for students who agree to work in underserved communities 
     ...
     which a State receives a grant under this section, and not 
     later than 6 years after such date, such State shall submit 
     to the Secretary a report that describes the results of the 
     activities carried out pursuant to the grant, including--
       ``(A) relevant information and relevant quantitative 
     indicators of the success of such activities in improving the 
     standard of care and maternal health outcomes for individuals 
     in rural and underserved communities who are seen for pre-
     conception, pregnancy, or postpartum visits in the rural 
     mobile health units, stratified by the categories of data 
     described in paragraph (2);
       ``(B) relevant qualitative evaluations from individuals 
     receiving pre-conception, pregnant, or postpartum care from 
     rural mobile health units provided through the grant, 
     including measures of patient-reported experience of care and 
     measures of patient-reported issues with access to care 
     without such rural mobile health unit; and
       ``(C) strategies to sustain such activities beyond the 
     duration of the grant and expand such activities to other 
     rural and underserved communities.
       ``(2) Categories of data.--The categories of data described 
     in this paragraph are the following:
       ``(A) Race, ethnicity, sex, gender, gender identity, 
     primary language, age, geography, disability status, and 
     insurance status.
     ...
     smears, and pregnancy.
       ``(3) Data privacy protection.--The reports required under 
     paragraph (1) shall not contain any personally identifiable 
     information regarding any pregnant or postpartum individual.
       ``(e) Evaluation.--Not later than December 31, 2032, the 
     Secretary shall conduct an evaluation of the pilot program 
     under this section to determine the impact of the pilot 
     ...
     insurance type, and such other factors as the Secretary 
     determines appropriate;
       ``(2) spending on maternity care by States participating in 
     the pilot program;
       ``(3) to the maximum extent practicable, qualitative and 
     quantitative measures of patient experience; and
       ``(4) any other areas of assessment that the Secretary 
     determines relevant.
       ``(f) Report.--Not later than 1 year after the completion 
     ...
     subsection (e); and
       ``(2) recommendations regarding whether the pilot program 
     should be continued and expanded on a national basis.
     ...
     United States; and
       ...
       (b) Period Covered.--The report under subsection (a) shall 
     cover the period of 2000 through 2024.
...
[[Page S5003]]
     ...
     beginning after 2026, the dollar amounts provided under this 
